...
function Cell(props) {
    return (
        <div className="grid-cell" id={props.id}>
            <div className="cell-number">{props.id}</div>
...
class Board extends Component {
    renderRow(row) {
        return (<div className="row"> {row.map((elem, idx) => {
...
class SnakesLaddersGame extends Component {
    ...
    rollDice = () => {
        ...
        let status = 'To play: ' + (!this.state.player1Turn ? 'Player 1' : 'Player 2');
        ...
        return (
            <div>
                ...
                <div className="console">
                    ...
                    <button className="dice-roll" onClick={this.rollDice}>Roll Dice</button>
